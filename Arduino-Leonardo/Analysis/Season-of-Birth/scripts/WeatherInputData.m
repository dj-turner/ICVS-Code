...
irradianceTbl = load("IrrandianceDataProcessed.mat");
weatherData.irradiance.UK = irradianceTbl.irradianceData(:,["month","year","UK"]);
weatherData.irradiance.China = irradianceTbl.irradianceData(:,["month","year","China"]);
