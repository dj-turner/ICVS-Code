...
while completedTrials < taskNumber
    ...
    while matchCount < length(matchOrder)
        ...
        disp("Reference light turning on!");
        ...
        while subTrialCompleted == 0
            ...
            elseif strcmp(keyName,'return')
                ...
                SaveRLMResultsEdited(ptptID, completedTrials + 1, red, green, lambda, lambdaDelta, matchType, timeTaken);
                ...
                if matchCount ~= 4 || completedTrials < taskNumber
                    pause(constants.nextTrialDelay);
                end

        elseif timeSoFar > constants.maxTrialSeconds
                disp("Trial took too long! Restarting trial...");
                subTrialCompleted = 1;
                matchCount = matchCount - 1;
                writeRGB(a, 0, 0, 0);
